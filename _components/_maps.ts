...
export const MAPS: readonly MapDef[] = [
  ...
  },
  {
    ...
    waves: [
      ...
      { name: 'Quick Step',        durationSec: 60, weights: { enemy_dasher: 0.43, enemy_speeder: 1.0 } },
      { name: 'Slipstream',        durationSec: 45, weights: { enemy_grunt: 0.6, enemy_speeder: 0.9 } },
      { name: 'Phase Shift',       durationSec: 75, weights: { enemy_speeder: 1.5, enemy_blinker: 0.27 } },
      { name: 'Velocity',          durationSec: 60, weights: { enemy_speeder: 2.0, enemy_elite: 1.5, enemy_hunter: 1.0 }, isBoss: true },
      { name: 'Terminal Velocity', durationSec: 90, weights: { enemy_speeder: 2.5, enemy_elite: 2.0, enemy_hunter: 1.4, enemy_dasher: 0.4, enemy_blinker: 0.3, enemy_charger: 1.0 } },
    ],
  },
]
